...
import ManualAccordion from "./ManualAccordion";
...
function ManualModels(){
    ...
    useEffect(()=>{
        ...
        const postOptions={
            ...
            body:JSON.stringify({type:"ridge"})
          }
    ...
    <div className="container">
        ...
        <div className="section-fiin">
            ...
            {models?<ManualAccordion modelList={models} setModels={setModels}/>:
